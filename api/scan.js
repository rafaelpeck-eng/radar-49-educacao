export default async function handler(req, res) {
  ...
  try {
    // Dados de exemplo baseados nos portais reais
    const licitacoesExemplo = [
      {
        ...
        relevancia: "ALTA",
        justificativaRelevancia: "Este edital da FAPESC busca promover a participação feminina em projetos de tecnologia e inovação. A 49 Educação, com NPS +94 e reconhecimento TOP 1 Educação pela Associação Brasileira de Startups, possui vasta experiência em programas de capacitação em inovação e tecnologia, tendo acelerado +1.200 startups catarinenses desde 2023. A empresa já executou programas similares como o Programa Nascer (800 startups) e Jornada Startups (600 startups) via FAPESC e SEBRAE/SC, demonstrando capacidade técnica para apoiar este chamamento.",
      ...
      },
      {
        ...
        relevancia: "ALTA",
        justificativaRelevancia: "Programa Centelha é focado em pré-incubação e capacitação de empreendedores - core business da 49 Educação. A empresa criou a primeira Startup University do Brasil e já capacitou +5.000 startups através da metodologia Startup University. Com cases comprovados como Taskdo (exit em 2024) e +R$ 1 bilhão em valuation gerado, a 49 Educação possui expertise em programas de pré-incubação, tendo executado o Programa Nascer em 15 cidades catarinenses (800 startups impactadas).",
        link: "https://fapesc.sc.gov.br/chamadas-abertas/",
        status: "ABERTO",
        diasRestantes: 40
      },
      ...
      },
      {
        ...
        relevancia: "ALTA",
        justificativaRelevancia: "Este edital do SEBRAE busca empresa especializada em treinamento de vendas para startups. A 49 Educação executou o programa Start Primeiras Vendas 2025/2026 para 150 startups e o programa Jornada Startups para +600 startups via ACATE. A empresa aplica metodologias de SPIN Selling, BANT, Growth Hacking e Playbook de Vendas, com resultados comprovados de aumento de faturamento nas startups atendidas.",
      ...
      {
        id: 5,
        titulo: "Licitação - Programa de Aceleração de Startups",
        orgao: "FIESC",
        portal: "FIESC",
        numero: "05/2025",
